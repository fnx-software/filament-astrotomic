...
@if (blank($livewireProperty))
    <div
        ...
        wire:ignore.self
        x-on:astrotomic-tab-switched.window="if ($event.detail.id === '{{ $id }}' || ! $event.detail.id) { tab = $event.detail.tab }"
        {{
            $attributes
                ->merge([
                    'id' => $id,
    ...
    >
        ...
        >
            @if (count($prefixActions))
                <div class="fi-sc-tabs-header-actions fi-sc-tabs-header-actions-start flex shrink-0 items-center gap-2">
            ...
            @if (count($suffixActions))
                <div class="fi-sc-tabs-header-actions fi-sc-tabs-header-actions-end ms-auto flex shrink-0 items-center gap-2">
